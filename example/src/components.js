...
class Another extends Component {
    ...
    render() {
        return (
            ...
            {this.context.intl.formatDate(new Date(), "time-style")}
            ...
            <FormattedMessage message={this.context.intl.getMessage('SHORT')}
                    product="apples"
                    price={2000.15}
                    deadline={new Date()}
                    timeZone="UTC" />
...
class WrapIntlComponent extends Component {
    static contextTypes = {
        intl: React.PropTypes.object
    };
